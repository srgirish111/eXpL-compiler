...
%type <no> expr Whilestmt Ifstmt Stmt Slist IDEN Fdef Body Rstmt MainBlock ArgList Heapstuff FIELD NULLTKN
%type <numb> NUM
...
Stmt	: READ'('IDEN')'';'	{$$=create_tree(0,TLookup("void"),NULL,read_node,$3,NULL,NULL);}
	|WRITE'('expr')'';'	{$$=create_tree(0,TLookup("void"),NULL,write_node,$3,NULL,NULL);}
	|IDEN'='expr';'	{typecheck($1);$$=create_tree(0,TLookup("void"),"=",assg_node,$1,$3,NULL);}
...
IDEN : ID {$$=create_tree(0,TLookup("void"),$1,var_node,NULL,NULL,NULL);printf("%s\n",$1);}		
		|
		ID '['expr']' {$$=create_tree(0,TLookup("void"),$1,var_node,$3,NULL,NULL);}
		;
%%
